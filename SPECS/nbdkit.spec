...
truncate -s 0 tests/test-memory-allocator-malloc-mlock.sh
%endif
%endif
...
%changelog
* Tue May 16 2023 Skip Grube <skip@rockylinux.org> - 1.24.0-5
- Added spec change to skip aarch64 failing test from upstream. ( https://bugzilla.redhat.com/show_bug.cgi?id=2044432 )
